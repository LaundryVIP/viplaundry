            ...
            <div class="row gy-5 align-items-center justify-content-between">
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Laundry Sepatu</h5><br>
                            {{-- <a href="#" class="btn btn-primary text-white">Pesan Sekarang</a> --}}
                            <div class="input-group mb-3">
                                <label class="input-group-text btn btn-primary text-white" for="inputGroupSelect01">Pilih
                                    Sepatu</label>
                                <select class="form-select" id="inputGroupSelect01">
                                    <option selected>Choose...</option>
                                    <option value="1">Sepatu Olahraga</option>
                                    <option value="2">Sepatu Outdoor</option>
                                    <option value="3">Sepatu Sneakers</option>
                                </select>
                            </div>
                        </div>
                    </div>
