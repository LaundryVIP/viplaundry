...
<head>
    ...
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('assets/logo/home.png') }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('assets/logo/home.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('assets/logo/home.png') }}">
    <link rel="icon" type="image/x-icon" href="{{ asset('assets/logo/home.ico') }}">
